        ...
        return (
            <div style={ style.mainCover }>
                ...
                <Grid container justify='center' alignItems='center' style={ style.content }>
                    ...
                    <Grid item xs={12}>
                        <Grid container justify='center' alignItems='center'>
                            <Typography component="h2" variant="overline" style={ style.mainText }>
                                {'Coiffure à domicile dans la Drôme Ardèche'.toUpperCase()}
                            </Typography>
                        </Grid>
                    </Grid>
                </Grid>
...
export default connect(mapStateToProps,mapDispatchToProps)(withStyles(globalStyle)(Cover));